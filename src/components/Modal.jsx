...
return (
    <div className='fixed top-0 left-0 w-full h-[100dvh] bg-black z-[1] flex items-center justify-center'>
        <div className='bg-white p-[20px] rounded-[5px] max-sm:h-[90dvh] sm:max-md:h-[80dvh] md:max-lg:h-[90dvh] md:max-lg:flex-col max-sm:flex-col sm:max-md:flex-col relative z-[2] w-[80%] flex gap-6'>
            <section>
