    ...
    <section className='w-full h-[100dvh] relative border border-red-400'>
        <section className='education border border-green-400 h-[100dvh]'>
            ...
            <article className='border border-yellow-400 grid nice w-full h-[60dvh]'>
                    <div className='flex border border-red-400 max-sm:flex-col max-sm:justify-around sm:max-md:justify-around sm:max-md:flex-col'>
                    <article className='border border-gray-950'>
                    ...
                    <div className='border max-sm:flex max-sm:justify-center max-sm:items-center sm:max-md:flex sm:max-md:justify-center sm:max-md:items-center border-gray-950'>
